...
export default defineComponent({
  ...
  setup() {
    ...
    const formComponent = ref('ObjetivoPercentualPadraoForm');

    const tableProps: ITableProps = {
      titulo: 'Objetivo por percentual - padrão',
      colunas: colunas,
      acoes: [],
      selecao: 'none',
      bordas: 'cell',
